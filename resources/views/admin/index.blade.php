...
@section('content')
    ...
    <!-- begin:: Widgets/Stats ===========================-->
    <div class="p-5" style="background-color: #e74c3c">
        <div class="m-portlet " style="background: #e74c3c; height: 100%">
                ...
                <div class="row m-row--no-padding m-row--col-separator-xl">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        ...
                        <h1 class="text-longshadow  "  >
                            <span class="wow fadeInRight " > مرحبا </span>
                            <span class="wow fadeInUp delay-1s" > بك </span>
                            <span class="wow fadeInUp delay-2s" > فى </span>
                            <span class="wow fadeInUp delay-3s" > لوحة  </span>
                            <span class="wow fadeInUp delay-4s" > تحكم  </span>
                            <br>
                            <br>
                            <span class="wow fadeInUp delay-5s"> {{ setting() ? setting()->title : '#' }}</span>
