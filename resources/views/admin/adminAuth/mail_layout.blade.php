                            ...
                            <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="#"><img class="w320" width="311" height="83" src="{{asset('website')}}/images/logoEN.png" alt="company logo" ></a>
                                        <br><br>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="background-color:#3bcdb0;">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="font-size:24px; text-align:center; padding: 0 75px; color:#fefefe;" class="w320 mobile-spacing">
                                                   <bold>  {{ $subject ? $subject : 'subject' }}  </bold>
                                                </td>
                                            </tr>
                                                ...
                                                <td style="text-align:center; margin:0 auto;">
                                                    ...
                                                    <div><!--[if mso]>
                                                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:45px;v-text-anchor:middle;width:180px;" stroke="f" fillcolor="#f5774e">
                                                            ...
                                                            <center>
                                                        <![endif]-->
                                                        <a href="http://yalahwy.com/"
                                                           style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:180px;-webkit-text-size-adjust:none;">Yalahwy</a>
                                                        <!--[if mso]>
                                                        </center>
                                                        </v:rect>
                                                        <![endif]--></div>
