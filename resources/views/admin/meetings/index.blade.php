...
<?php
    $home_title    =  trans('admin.main_name' )  . ' | ' . $page_titles['index'];
    $first_title   = ["title"=> $page_titles['index'], "url"=> aurl('zoom') ];
?>
...
<div class="box">
  <div class="box-header row">
    ...
    <div class="col-md-10 col-sm-8 col-xs-12">
      ...
      <div class="col-md-2 col-sm-4 col-xs-12" >
        ...
        <a href="{{ aurl('zoom/create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air" >
          <span>
            <i class="la la-plus"></i>
            <span> {{ $page_titles['create'] }} </span>
          </span>
        </a>
  ...
  <div class="box-body table-responsive text-nowrap bg_color">
  	{!! Form::open(['id'=>'form_data','route' => 'delete_all_slider', 'method' => 'delete']) !!}
