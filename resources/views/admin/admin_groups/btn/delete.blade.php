...
<div id="del_admin{{ $id }}" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      {!! Form::open(['route'=>['permission_group.destroy',$id],'method'=>'delete']) !!}
      <div class="modal-body">
        <h4>{{ trans('admin.delete_this',['name'=>$id]) }}</h4>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info text-center" data-dismiss="modal">{{ trans('admin.close') }}</button>
